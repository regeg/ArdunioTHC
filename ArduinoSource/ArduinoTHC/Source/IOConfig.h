...
//
#define OUT_D_ARC_GOOD_ACTIVE			HIGH
#define OUT_D_ARC_GOOD_NOT_ACTIVE		LOW
#define OUT_D_TORCH_UP_ACTIVE			HIGH
#define OUT_D_TORCH_UP_NOT_ACTIVE		LOW
#define OUT_D_TORCH_DOWN_ACTIVE			HIGH
#define OUT_D_TORCH_DOWN_NOT_ACTIVE		LOW
